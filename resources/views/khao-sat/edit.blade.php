        ...
        <form action="{{ route('khao-sat.luu', $doanhNghiepKhaoSat) }}" method="POST" id="form-khao-sat"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="ma_nganh" {{ $doanhNghiepKhaoSat->trang_thai === 'da_tinh' ? 'disabled' : '' }}
                            ...
                            @foreach (['26' => '26 - Sản xuất SP điện tử, máy vi tính', '46' => '46 - Bán buôn', '58' => '58 - Xuất bản', '62' => '62 - Lập trình máy tính, dịch vụ tư vấn', 'khac' => 'Khác'] as $val => $label)
            ...
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden mb-4">
                <div class="bg-gray-50 px-4 py-3 border-b border-gray-100">
                    <p class="text-sm font-semibold text-gray-800">Giá trị gia tăng doanh nghiệp (đơn vị: tỷ đồng)</p>
                </div>
                <div class="p-4 overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-gray-400 text-xs">
                                <th class="text-left pb-2 font-medium">Năm</th>
                                <th class="text-left pb-2 font-medium">Khấu hao TSCĐ</th>
                                <th class="text-left pb-2 font-medium">Thu nhập lao động</th>
                                <th class="text-left pb-2 font-medium">Thu nhập DN</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-1.5 pr-3">
                                    <input type="number" step="0.01" name="tai_chinh[{{ $n }}][khau_hao_tscd]" value="{{ $row->khau_hao_tscd ?? '' }}"
                                        {{ $doanhNghiepKhaoSat->trang_thai === 'da_tinh' ? 'disabled' : '' }}
                                        class="w-28 rounded-lg border border-gray-300 text-sm px-2 py-1.5 focus:border-blue-600 focus:ring-blue-600 disabled:bg-gray-50 disabled:text-gray-400">
                                </td>
                                <td class="py-1.5 pr-3">
